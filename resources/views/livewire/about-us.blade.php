<div class="about-us">
    @section('meta')
        <x-meta-tags title="{{ $seopages->about_meta_title }}" description="{{ $seopages->about_meta_description }}"
            ogTitle="{{ $seopages->about_meta_title }}" ogDescription="{{ $seopages->about_meta_description }}"
    ...
    <section class="section position-relative hero-section">
        <div class="hero-inner-banner-section d-block">
            <img src="{{ asset('storage/' . $pageHeading->about_bg_image) }}"
                srcset="{{ asset('storage/' . $pageHeading->about_bg_image) }} 300w, {{ asset('storage/' . $pageHeading->about_bg_image) }} 600w, {{ asset('storage/' . $pageHeading->about_bg_image) }} 900w, {{ asset('storage/' . $pageHeading->about_bg_image) }} 1200w, {{ asset('storage/' . $pageHeading->about_bg_image) }} 1500w"
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-4 mb-lg-0 mb-md-0">
                    <div class="image-box-wrapper mt-100 mb-5">
                        <img src="{{ asset('storage/' . $pageHeading->ourstory_image) }}"
                            srcset="{{ asset('storage/' . $pageHeading->ourstory_image) }} 300w, {{ asset('storage/' . $pageHeading->ourstory_image) }} 600w, {{ asset('storage/' . $pageHeading->ourstory_image) }} 900w, {{ asset('storage/' . $pageHeading->ourstory_image) }} 1200w, {{ asset('storage/' . $pageHeading->ourstory_image) }} 1500w"
                            sizes="(max-width: 480px) 300px, (max-width: 768px) 600px, (max-width: 1024px) 900px, 1200px"
                ...
                <div class="col-lg-5 col-md-6 offset-lg-1">
                    <div class="content-box-wrapper mt-100">
                        ...
                        <a wire:navigate href="{{ $pageHeading->btn_6_url }}"
                            class="btn custom-btn mt-4">{{ $pageHeading->btn_6 }}</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-4 mb-lg-0 mb-md-0 order-lg-2 order-md-2 offset-lg-1">
                    <div class="image-box-wrapper image-box-wrapper-alt mb-5">
                        <img src="{{ asset('storage/' . $pageHeading->whychoose_image) }}"
                            srcset="{{ asset('storage/' . $pageHeading->whychoose_image) }} 300w, {{ asset('storage/' . $pageHeading->whychoose_image) }} 600w, {{ asset('storage/' . $pageHeading->whychoose_image) }} 900w, {{ asset('storage/' . $pageHeading->whychoose_image) }} 1200w, {{ asset('storage/' . $pageHeading->whychoose_image) }} 1500w"
                            sizes="(max-width: 480px) 300px, (max-width: 768px) 600px, (max-width: 1024px) 900px, 1200px"
                            alt="Responsive Example Image">
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 order-lg-1 order-md-1">
                    <div class="content-box-wrapper">
                        ...
                        <a wire:navigate href="{{ $pageHeading->btn_7_url }}"
                            class="btn custom-btn mt-5">{{ $pageHeading->btn_7 }}</a>
                    </div>
                </div>
